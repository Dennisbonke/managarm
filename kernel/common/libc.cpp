...
template<typename T>
[[gnu::always_inline, gnu::artificial]] inline word<T> alias_load(const unsigned char *&p) {
...
template<typename T>
[[gnu::always_inline, gnu::artificial]] inline void alias_store(unsigned char *&p, word<T> value) {
