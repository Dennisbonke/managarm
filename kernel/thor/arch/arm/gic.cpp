...
namespace {
constexpr static uint8_t defaultPrio = 0xA0;
}  // namespace
...
namespace dist_reg {
constexpr static uintptr_t irqGroupBase = 0x80;
constexpr static uintptr_t irqSetEnableBase = 0x100;
constexpr static uintptr_t irqClearEnableBase = 0x180;
constexpr static uintptr_t irqSetPendingBase = 0x200;
constexpr static uintptr_t irqClearPendingBase = 0x280;
constexpr static uintptr_t irqPriorityBase = 0x400;
constexpr static uintptr_t irqTargetBase = 0x800;
constexpr static uintptr_t irqConfigBase = 0xC00;
constexpr static uintptr_t sgiSetPendingBase = 0xF10;
constexpr static uintptr_t sgiClearPendingBase = 0xF20;

constexpr static arch::bit_register<uint32_t> control {0x00};
constexpr static arch::bit_register<uint32_t> type {0x04};
constexpr static arch::bit_register<uint32_t> sgi {0xF00};
}  // namespace dist_reg
...
constexpr static uintptr_t activePriorityBase = 0xD0;
}  // namespace cpu_reg
