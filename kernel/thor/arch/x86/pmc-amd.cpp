...
namespace counters {
constexpr inline unsigned int clockCycles = 0x76;
constexpr inline unsigned int instructionsRetired = 0xC0;
}  // namespace counters
...
void setAmdPmc() {
	...
	// This is hardcoded to yield a fixed number of events per second on a 1 GHz machine for
	// now.
