...
constexpr inline arch::bit_register<uint32_t> lApicId(0x0020);
constexpr inline arch::scalar_register<uint32_t> lApicEoi(0x00B0);
constexpr inline arch::bit_register<uint32_t> lApicSpurious(0x00F0);
constexpr inline arch::bit_register<uint32_t> lApicIcrLow(0x0300);
constexpr inline arch::bit_register<uint32_t> lApicIcrHigh(0x0310);
constexpr inline arch::bit_register<uint64_t> lX2ApicIcr {0x0300};
constexpr inline arch::bit_register<uint32_t> lApicLvtTimer(0x0320);
constexpr inline arch::bit_register<uint32_t> lApicLvtPerfCount(0x0340);
constexpr inline arch::bit_register<uint32_t> lApicLvtLocal0(0x0350);
constexpr inline arch::bit_register<uint32_t> lApicLvtLocal1(0x0360);
constexpr inline arch::scalar_register<uint32_t> lApicInitCount(0x0380);
constexpr inline arch::scalar_register<uint32_t> lApicCurCount(0x0390);

// lApicId registers
constexpr inline arch::field<uint32_t, uint8_t> apicId(24, 8);
constexpr inline arch::field<uint32_t, uint8_t> x2ApicId(0, 8);

// lApicSpurious registers
constexpr inline arch::field<uint32_t, uint8_t> apicSpuriousVector(0, 8);
constexpr inline arch::field<uint32_t, bool> apicSpuriousSwEnable(8, 1);
constexpr inline arch::field<uint32_t, bool> apicSpuriousFocusProcessor(9, 1);
constexpr inline arch::field<uint32_t, bool> apicSpuriousEoiBroadcastSuppression(12, 1);

// lApicIcrLow registers
constexpr inline arch::field<uint32_t, uint8_t> apicIcrLowVector(0, 8);
constexpr inline arch::field<uint32_t, uint8_t> apicIcrLowDelivMode(8, 3);
constexpr inline arch::field<uint32_t, bool> apicIcrLowDestMode(11, 1);
constexpr inline arch::field<uint32_t, bool> apicIcrLowDelivStatus(12, 1);
constexpr inline arch::field<uint32_t, bool> apicIcrLowLevel(14, 1);
constexpr inline arch::field<uint32_t, bool> apicIcrLowTriggerMode(15, 1);
constexpr inline arch::field<uint32_t, uint8_t> apicIcrLowShorthand(18, 2);

// lApicIcrHigh registers
constexpr inline arch::field<uint32_t, uint8_t> apicIcrHighDestField(24, 8);

// lX2ApicIcr registers
constexpr inline arch::field<uint64_t, uint8_t> x2apicIcrLowVector(0, 8);
constexpr inline arch::field<uint64_t, uint8_t> x2apicIcrLowDelivMode(8, 3);
constexpr inline arch::field<uint64_t, bool> x2apicIcrLowDestMode(11, 1);
constexpr inline arch::field<uint64_t, bool> x2apicIcrLowDelivStatus(12, 1);
constexpr inline arch::field<uint64_t, bool> x2apicIcrLowLevel(14, 1);
constexpr inline arch::field<uint64_t, bool> x2apicIcrLowTriggerMode(15, 1);
constexpr inline arch::field<uint64_t, uint8_t> x2apicIcrLowShorthand(18, 2);
constexpr inline arch::field<uint64_t, uint32_t> x2apicIcrHighDestField(32, 32);

// lApicLvtTimer registers
constexpr inline arch::field<uint32_t, uint8_t> apicLvtVector(0, 8);
constexpr inline arch::field<uint32_t, bool> apicLvtMask(16, 1);
constexpr inline arch::field<uint32_t, uint8_t> apicLvtMode(8, 3);
constexpr inline arch::field<uint32_t, uint8_t> apicLvtTimerMode(17, 2);
...
constexpr inline arch::scalar_register<uint32_t> apicIndex(0x00);
constexpr inline arch::scalar_register<uint32_t> apicData(0x10);

namespace pin_word1 {
constexpr inline arch::field<uint32_t, unsigned int> vector(0, 8);
constexpr inline arch::field<uint32_t, unsigned int> deliveryMode(8, 3);
//	inline constexpr arch::field<uint32_t, bool> logicalMode(11, 1);
constexpr inline arch::field<uint32_t, bool> deliveryStatus(12, 1);
constexpr inline arch::field<uint32_t, bool> activeLow(13, 1);
constexpr inline arch::field<uint32_t, bool> remoteIrr(14, 1);
constexpr inline arch::field<uint32_t, bool> levelTriggered(15, 1);
constexpr inline arch::field<uint32_t, bool> masked(16, 1);
};  // namespace pin_word1

namespace pin_word2 {
constexpr inline arch::field<uint32_t, unsigned int> destination(24, 8);
};  // namespace pin_word2
