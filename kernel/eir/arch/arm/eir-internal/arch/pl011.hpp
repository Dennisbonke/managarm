...
constexpr static arch::scalar_register<uint32_t> i_baud {0x24};
constexpr static arch::scalar_register<uint32_t> f_baud {0x28};
constexpr static arch::bit_register<uint32_t> control {0x30};
constexpr static arch::bit_register<uint32_t> line_control {0x2c};
constexpr static arch::scalar_register<uint32_t> int_clear {0x44};
}  // namespace pl011_reg
...
constexpr static arch::field<uint32_t, bool> rx_en {9, 1};
constexpr static arch::field<uint32_t, bool> tx_en {8, 1};
constexpr static arch::field<uint32_t, bool> uart_en {0, 1};
};  // namespace pl011_control

namespace pl011_line_control {
constexpr static arch::field<uint32_t, uint8_t> word_len {5, 2};
constexpr static arch::field<uint32_t, bool> fifo_en {4, 1};
}  // namespace pl011_line_control
...
struct PL011 {
	...
	void init(uint64_t baud) {
		...
		space_.store(
			pl011_reg::control,
			pl011_control::rx_en(true) | pl011_control::tx_en(true)
