...
struct RegularNode
: FsNode
, std::enable_shared_from_this<RegularNode> {
...
, std::enable_shared_from_this<DirectoryNode> {
	...
	std::shared_ptr<Link>
	directMkregular(std::string name, std::shared_ptr<RegularNode> regular);
...
struct SelfLink final
: FsNode
, std::enable_shared_from_this<SelfLink> {
	SelfLink() = default;
...
struct SelfThreadLink final
: FsNode
, std::enable_shared_from_this<SelfThreadLink> {
...
struct ExeLink final
: FsNode
, std::enable_shared_from_this<ExeLink> {
...
struct RootLink final
: FsNode
, std::enable_shared_from_this<RootLink> {
...
struct CwdLink final
: FsNode
, std::enable_shared_from_this<CwdLink> {
