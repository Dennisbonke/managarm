...
constexpr inline size_t inputCtxCtrl = 0;
constexpr inline size_t inputCtxSlot = 1;
constexpr inline size_t inputCtxEp0 = 2;

constexpr inline size_t deviceCtxSlot = 0;
constexpr inline size_t deviceCtxEp0 = 1;
